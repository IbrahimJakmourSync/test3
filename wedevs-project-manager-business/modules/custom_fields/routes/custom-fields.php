...
$router->post( 'projects/{project_id}/custom-fields/{field_id}/tasks/{task_id}/update', 'WeDevs\PM_Pro\Modules\custom_fields\src\Controllers\Custom_Field_Controller@store_field_value' )
    ->permission( ['WeDevs\PM\Core\Permissions\Access_Project'] );
