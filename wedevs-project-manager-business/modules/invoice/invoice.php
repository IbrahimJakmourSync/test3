...
add_action('pm-activation-invoice', 'pm_pro_create_invoice_table', 10);
...
// 	require_once dirname(__FILE__) . "/includes/dompdf_f/dompdf_config.inc.php";
...
// require_once dirname(__FILE__) . '/includes/dompdf/load_font.php';
...
// $hind_siliguriu = dirname(__FILE__) . '/includes/dompdf/lib/fonts/HindSiliguriu.ttf';

// ob_start();
// install_font_family( $dompdf, 'HindSiliguriu', $hind_siliguriu );
