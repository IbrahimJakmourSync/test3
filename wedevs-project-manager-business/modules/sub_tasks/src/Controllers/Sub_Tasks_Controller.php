...
class Sub_Tasks_Controller {
    ...
    public function store( WP_REST_Request $request ) {
        ...
        if ( $project ) {
            $data = apply_filters( 'pm_pro_before_create_subtask', $data, $request );
        ...
        do_action('pm_after_create_subtask', $task, $request );
        ...
        do_action( 'pm_create_subtask_after_transformer', $resource, $request->get_params() );
    ...
    public function update( WP_REST_Request $request ) {
        ...
        if ( $sub_task ) {
            ...
            $data = apply_filters( 'pm_pro_before_update_subtask', $data, $request, $sub_task );
        ...
        do_action( 'pm_udpate_subtask_after_transformer', $resource, $request->get_params() );
